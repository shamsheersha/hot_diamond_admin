      ...
      if (fcmToken != null) {
        ...
        switch (newStatus) {
          case OrderStatus.confirmed:
            body = "Hi $userName, Your order #$orderId has been confirmed. We're preparing your items!";
            break;
          case OrderStatus.processing:
            body = "Hi $userName, Your order #$orderId is now being processed.";
            break;
          case OrderStatus.shipped:
            body = "Hi $userName, Your order #$orderId has been shipped. Track your package now!";
            break;
          case OrderStatus.delivered:
            body = "Hi $userName, Your order #$orderId has been delivered. Thank you for shopping with us!";
            break;
          case OrderStatus.cancelled:
            body = "Hi $userName, Your order #$orderId has been cancelled. Please contact support for more details.";
            break;
          default:
